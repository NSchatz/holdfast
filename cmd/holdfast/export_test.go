...
// has. That newest step is now the schema version each record was written under, appended
// after which library profile decided the row, so the version below and the objects
