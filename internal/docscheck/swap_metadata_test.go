...
func TestCheck_SwapMetadataAnchorMissingFails(t *testing.T) {
	dir := writeCorpus(t, map[string]string{
		"docs.md": residualWindowBlock() + postureBlock() + agreeingBlocks() + nonGoalBlock() + differentiatorBlock() + "\n# Volumes\n\nMount your library at /media.\n",
	})
...
func TestCheck_SwapMetadataClausesMustBeCarriedByOneStatement(t *testing.T) {
	dir := writeCorpus(t, map[string]string{
		"a.md": residualWindowBlock() + postureBlock() + agreeingBlocks() + nonGoalBlock() + differentiatorBlock(),
